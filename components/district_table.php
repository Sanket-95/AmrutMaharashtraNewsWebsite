...
<div class="card shadow-sm">
    <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
            <i class="bi bi-table me-2"></i>District-wise News Data Table
        </h5>
        ...
        <?php else: ?>
                ...
                <div class="row">
                    <div class="col-md-4 mb-2 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="text-muted small">Total Districts</div>
                    ...
                    <div class="col-md-4 mb-2 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="text-muted small">Total News Articles</div>
                ...
                <div class="row g-2">
                    <div class="col-md-8">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control" id="tableSearch" placeholder="Search districts or categories...">
                    ...
                    <div class="col-md-4">
                        <select class="form-select form-select-sm" id="sortBy">
                            <option value="district">Sort by District (A-Z)</option>
                            <option value="district_desc">Sort by District (Z-A)</option>
                            <option value="total" selected>Sort by Total News (High-Low)</option>
                            <option value="total_asc">Sort by Total News (Low-High)</option>
                            <option value="views">Sort by Views (High-Low)</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover table-striped mb-0" id="districtTable">
                    <thead class="table-dark" style="position: sticky; top: 0; z-index: 10;">
                        <tr>
                            ...
                            <th width="15%" class="text-end">Total News</th>
                            <th width="15%" class="text-end">Total Views</th>
                            <th width="15%" class="text-end">Avg. Views/News</th>
                            <th width="15%" class="text-center">Categories</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        ...
                        <tr class="district-row" data-district="<?php echo htmlspecialchars($district); ?>">
                            ...
                            <td class="text-center">
                                <span class="badge bg-primary rounded-pill">
                                    <?php echo count($district_categories); ?> categories
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr class="collapse" id="details-<?php echo $counter; ?>">
                            <td colspan="5" class="bg-light p-0">
                                <div class="p-3">
                                    <h6 class="mb-3">Category-wise Breakdown for <?php echo htmlspecialchars($district); ?></h6>
                                    <div class="row">
                                        <?php 
                                        $cat_counter = 0;
                                        ...
                                        <div class="col-12">
                                            <div class="alert alert-warning mb-0">
                                                ...
                                                No category data available for this district.
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                    ...
                    <tfoot class="table-light">
                        <tr>
                            ...
                            <td class="text-center fw-bold">
                                <?php echo count($allCategories); ?> total categories
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="p-3 border-top">
                <div class="text-muted small">
                    Showing <?php echo count($districts); ?> districts with <?php echo count($allCategories); ?> categories
                </div>
            </div>
        <?php endif; ?>
    </div>
